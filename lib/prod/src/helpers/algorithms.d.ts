...
export declare function upperbound<TArrayElementType, TValueType>(arr: TArrayElementType[], value: TValueType, compare: UpperBoundComparatorType<TValueType, TArrayElementType>, start?: number, to?: number): number;
